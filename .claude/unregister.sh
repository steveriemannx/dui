#!/bin/bash
# dui AI toolchain - global unregister script
...
echo "=== dui AI toolchain unregister ==="
...
# Remove all dui-* global skills
for skill_dir in "${GLOBAL_SKILLS_DIR}"/dui-*; do
    if [ -d "$skill_dir" ]; then
...
echo ""
echo "All dui global skills removed."
echo ""
