...
nim_duilib supports reusing XML fragments with `<Include src="fragment.xml"/>`, letting multiple windows share the same piece of layout (for example, a common status bar or toolbar).
