...
description: nim_duilib resource packaging and deployment (ZIP packaging, embedding into the executable, single-file release); configure how resources are loaded
---

# Resource Packaging and Deployment in nim_duilib
