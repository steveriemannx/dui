...
description: Customize nim_duilib themes (colors, fonts, common style classes, icons), modify global.xml, and create custom styles
---

# Theme and Style Customization in nim_duilib
