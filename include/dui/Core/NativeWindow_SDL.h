...
public:
    ...
    */
    U8String GetVideoDriverName() const;

    /** Gets the name of the current Render drawing engine
    */
    U8String GetWindowRenderName() const;
...
public:
    ...
    */
    bool SetWindowIcon(const std::vector<uint8_t>& iconFileData, const U8String& iconFileName);
...
private:
    ...
    */
    SDL_Renderer* CreateSdlRenderer(const U8String& sdlRenderName) const;

    /** Gets the Render name list (in priority order)
    */
    void GetRenderNameList(const U8String& externalRenderName, std::vector<U8String>& renderNames) const;
    ...
    */
    void QueryRenderProperties(const U8String& externalRenderName, bool& bOpenGL, bool& bOpenGLES2, bool& bSupportTransparent) const;

    /** Determines whether a Render supports transparency
    */
    bool IsRenderSupportTransparent(const U8String& renderName) const;
...
private:
    ...
    * @param [out] bHandled If true is returned, the event has been handled and will not be forwarded to other UI controls
    */
    void OnDropTexts(const std::vector<U8String>& textList, const UiPoint& pt, bool& bHandled);
    ...
    * @param [out] bHandled If true is returned, the event has been handled and will not be forwarded to other UI controls
    */
    void OnDropFiles(const U8String& source, const std::vector<U8String>& fileList, const UiPoint& pt, bool& bHandled);
