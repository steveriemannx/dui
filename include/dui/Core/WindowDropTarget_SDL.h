...
public:
    ...
    */
    void OnDropText(const U8String& utf8Text);

    /** SDL_EVENT_DROP_FILE
    *@param [in] utf8Source Drag and drop source
    *@param [in] utf8File File path; each call provides one file
    */
    void OnDropFile(const U8String& utf8Source, const U8String& utf8File);
...
private:
    ...
    */
    ...
    /** Text data
    */
    std::vector<U8String> m_textList;

    /** File data
    */
    std::vector<U8String> m_fileList;

    /** The source of the files
    */
    U8String m_fileSource;
};

} // namespace ui

#endif //defined (DUI_BUILD_FOR_SDL)
