#ifndef UI_CORE_NATIVE_WINDOW_X11_H_
#define UI_CORE_NATIVE_WINDOW_X11_H_
...
struct wl_callback;
#endif
typedef uint32_t X11_WindowID;
typedef uint64_t X11_WindowFlags;
typedef uint32_t X11_Keycode;
typedef uint16_t X11_Keymod;
typedef uint32_t X11_PropertiesID;
...
{
public:
    explicit NativeWindow_X11(INativeWindow* pOwner);
    NativeWindow_X11(const NativeWindow_X11& r) = delete;
    NativeWindow_X11& operator=(const NativeWindow_X11& r) = delete;
    ~NativeWindow_X11();
...
public:
    ...
    */
    static NativeWindow_X11* GetWindowFromID(X11_WindowID id);
...
public:
    ...
    */
    bool CreateWnd(NativeWindow_X11* pParentWindow,
    ...
    */
    int32_t DoModal(NativeWindow_X11* pParentWindow,
                    const WindowCreateParam& createParam,
                    const WindowCreateAttributes& createAttributes,
    ...
    */
    bool CreateChildWnd(NativeWindow_X11* pParentWindow, int32_t nX, int32_t nY, int32_t nWidth, int32_t nHeight);
    ...
    */
    bool SetParentWindow(NativeWindow_X11* pParentWindow);
...
public:
    ...
    */
    void ShowModalFake(NativeWindow_X11* pParentWindow);

    /** The modal dialog closed; synchronize the state
    */
    void OnCloseModalFake(NativeWindow_X11* pParentWindow);
...
public:
    ...
    */
    bool SetWindowPos(const NativeWindow_X11* pInsertAfterWindow,
...
private:
    ...
    */
    bool CreateWindowAndRender(NativeWindow_X11* pParentWindow, const WindowCreateAttributes& createAttributes);
    ...
    */
    void SetCreateWindowProperties(X11_PropertiesID props,
                                   NativeWindow_X11* pParentWindow,
                                   const WindowCreateAttributes& createAttributes,
                                   bool bUseOpenGL);
    ...
    */
    X11_Window* CreateX11Window(NativeWindow_X11* pParentWindow, const WindowCreateAttributes& createAttributes);

    /** Calculates the centered window position
    */
    bool CalculateCenterWindowPos(X11_Window* pCenterWindow, int32_t& xPos, int32_t& yPos) const;

    /** Checks the window edge-snap operation and calls back to the application layer
    */
    void CheckWindowSnap(X11_Window* window);

private:
    /** Sets the mapping between the window ID and the window pointer
    */
    static void SetWindowFromID(X11_WindowID id, NativeWindow_X11* pNativeWindow);
...
private:
    /** The mapping between window pointers and X11 window IDs, used to relay messages
    */
    static std::unordered_map<X11_WindowID, NativeWindow_X11*> s_windowIDMap;
    ...
    */
    ...
    /** The X11 window rendering interface
    */
    void* m_x11Renderer;
    ...
    */
    X11_WindowFlags m_lastWindowFlags;
    ...
    */
    ...
    /** Normal window geometry saved while maximized
    */
    UiRect m_rcRestoreWindow;
    ...
    */
    ...
    Time m_lastButtonPressTime;
    UiPoint m_lastButtonPressPos;

    /** Active drag state for the custom caption bar
    */
    bool m_bWindowMoving;
    int32_t m_nMoveStartRootX;
    int32_t m_nMoveStartRootY;
    int32_t m_nMoveStartWindowX;
    int32_t m_nMoveStartWindowY;
    bool m_bWindowPositionKnown;
    int32_t m_nWindowPositionX;
    int32_t m_nWindowPositionY;
...
/** Defines an alias
*/
typedef NativeWindow_X11 NativeWindow;

} // namespace ui

#endif //DUI_BUILD_FOR_X11

#endif // UI_CORE_NATIVE_WINDOW_X11_H_
