...
public:
    ...
    */
    virtual void OnDropTexts(const std::vector<U8String>& textList, const UiPoint& pt) override;
    ...
    */
    virtual void OnDropFiles(const U8String& source, const std::vector<U8String>& fileList, const UiPoint& pt) override;
