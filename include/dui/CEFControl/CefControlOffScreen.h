/**@brief Encapsulates the Cef browser object as a dui control
...
/** dui CEF control, off-screen rendering mode
*/
class DUI_API CefControlOffScreen :public CefControl
{
