...
#include "dui/CEFControl/CefControlEvent.h"
...
/**@brief Wraps the CEF browser object as a dui control base class
 * @copyright (c) 2016, NetEase Inc. All rights reserved
 * @author Redrain
 * @date 2019/3/20
 */
class DUI_API CefControl: public Control, public CefBrowserHandlerDelegate
{
