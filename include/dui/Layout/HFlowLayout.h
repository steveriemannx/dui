...
/** Horizontal flow layout: child controls are arranged in sequence horizontally; when the target area width is exceeded, the row wraps automatically
 *  Horizontal alignment: left-aligned by default; the alignment specified by a child control itself does not take effect
 *  Vertical alignment: none by default; child controls are arranged according to the alignment specified by each child control (within the same row)
 */
class DUI_API HFlowLayout : public Layout
{
