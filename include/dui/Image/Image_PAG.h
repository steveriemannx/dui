...
public:
    ...
    * @param [in] bLoadAllFrames Whether to load all frames; if false, only the first frame is loaded; if true, all frames are loaded
    * @param [in] fPagMaxFrameRate The frame rate for decoding the animation
