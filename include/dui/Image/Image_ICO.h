...
namespace ui
{
/** Image data in ICO format (multi-frame mode)
*/
...
public:
    /** Load the image data
    * @param [in] imageData The image file data
    * @param [in] fImageSizeScale The image scaling percentage
    * @param [in] nIconSize The size of the ICO image to load
    * @param [in] nFrameDelayMs The time interval of each frame, milliseconds
    */
