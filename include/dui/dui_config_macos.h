#ifndef DUI_CONFIG_MACOS_H_
#define DUI_CONFIG_MACOS_H_
...
// Resource path definitions (macOS uses the bundle structure)
    ...
    #define DUI_RESOURCE_PATH [[NSBundle mainBundle] resourcePath].UTF8String
#else
    #define DUI_RESOURCE_PATH ""
#endif

#endif // DUI_CONFIG_MACOS_H_
