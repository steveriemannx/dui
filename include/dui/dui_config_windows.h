#ifndef DUI_CONFIG_WINDOWS_H_
#define DUI_CONFIG_WINDOWS_H_
...
//When using the dynamic library, the DUI_DLL macro must be defined in the application VS project
#if defined(DUI_DLL)
