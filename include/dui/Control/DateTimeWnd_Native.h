#ifndef _UI_CONTROL_DATETIME_WND_Native_H_
#define _UI_CONTROL_DATETIME_WND_Native_H_
...
/** The implementation of the date time selection control (native backend)
*/
...
#endif // _UI_CONTROL_DATETIME_WND_Native_H_
