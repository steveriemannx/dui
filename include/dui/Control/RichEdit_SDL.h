...
struct FindTextParam
{
    ...
    U8String findText;            //The text to search for
};

class DUI_API RichEdit : public ScrollBox, protected IRichTextData
{
...
public:
    ...
    virtual U8String GetType() const override;
    virtual void SetAttribute(const U8String& pstrName, const U8String& pstrValue) override;
...
public:
     ...
     */
    int32_t InsertText(int32_t nInsertAfterChar, const U8String& text, bool bCanUndo = false);
     ...
     */
    int32_t AppendText(const U8String& text, bool bCanUndo = false, bool bScrollBottom = true);
    ...
    */
     ...
     */
    void SetFontId(const U8String& strFontId);
...
public:
    ...
    */
    std::wstring::value_type GetPasswordChar() const;
    ...
    */
    void SetNumberFormat64(const U8String& numberFormat);

    /** Get the number format (the format of a 64-bit signed integer)
    */
    U8String GetNumberFormat64() const;
    ...
    */
    bool SetEnableSpin(bool bEnable, const U8String& spinClass, int32_t nMin = 0, int32_t nMax = 0);
...
public:
    ...
    */
     ...
     */
    void SetCaretColor(const U8String& dwColor);

    /** Get the caret color
     * @return Returns the caret color
     */
    U8String GetCaretColor() const;
...
public:
     ...
     */
    bool ReplaceSel(const U8String& newText, bool bCanUndo);

    /** Get the selected text content
     * @return Returns the selected text content
     */
    U8String GetSelText() const;
    ...
    */
     ...
     */
    U8String GetTextRange(int32_t nStartChar, int32_t nEndChar) const;
    ...
    */
    void SetFocusBottomBorderColor(const U8String& bottomBorderColor);

    /** Get the color of the bottom border in the focused state
    */
    U8String GetFocusBottomBorderColor() const;
    ...
    */
     ...
     */
    U8String GetLine(int32_t nIndex, int32_t nMaxLength) const;
...
protected:
    ...
    */
    virtual void ReplacePasswordChar(std::wstring& text) const override;
...
private:
    ...
    */
    bool SetSpinClass(const U8String& spinClass);
...
private:
    ...
    */
    void SetClearBtnClass(const U8String& btnClass);

    /** Set the Class name of the show-password button function
    */
    void SetShowPasswordBtnClass(const U8String& btnClass);

    /** Set the font ID
    */
    void SetFontIdInternal(const U8String& fontId);

    /** Get the font interface
    */
    IFont* GetIFontInternal(const U8String& fontId) const;

    /** Get the internal font ID of this control
    */
    U8String GetInternalFontId() const;
    ...
    */
    ...
    /** Font changed
    */
    void OnFontChanged(const U8String& fontId);
...
private:
    ...
    */
    bool RemoveInvalidPasswordChar(U8String& text);
    bool RemoveInvalidPasswordChar(std::wstring& text);
...
private:
    ...
    std::wstring::value_type m_chPasswordChar;   //The password character
