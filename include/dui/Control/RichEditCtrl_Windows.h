...
//Only the Unicode version is supported
#if !defined(_UNICODE) && (_RICHEDIT_VER >= 0x0500)
  #undef MSFTEDIT_CLASS
  #define MSFTEDIT_CLASS    "RICHEDIT50W"
#endif

/** Main function wrapper of the RichEdit control (from WTL source code)
*/
class DUI_API RichEditCtrl
{
public:
// Constructors
...
// Attributes
    ...
    */
    ...
    // Operations(set the maximum character format, same as SetLimitText)
