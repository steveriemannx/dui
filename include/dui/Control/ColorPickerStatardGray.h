...
namespace ui
{
/** Color picker: standard colors, gray
*/
class DUI_API ColorPickerStatardGray : public Control
{
...
public:
    ...
    */
    ...
    /** Calculate the size of the control (width and height)
     ...
     *  @return The estimated size of the control, including padding (Box), excluding margin
     */
