...
namespace ui
{
/** Implementation of reference counting (modified from the Skia source code skia\include\core\SkRefCnt.h)
*/
class RefCount
{
public:
    /** Default constructor; the initial reference count is 1
    */
...
/** Reference counting implementation without virtual functions
*/
