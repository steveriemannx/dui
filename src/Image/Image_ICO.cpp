                                    ...
                                    int32_t nFrameDelayMs)
{
    ...
    //Use the nIconSize parameter as the size of the image
    ...
    for (int i = 0; i < nFrameCount; ++i) {
        ...
        //The width and height of the image must not exceed the agreed value (shrink the image if it exceeds)
        ...
        //Calculate the offset (to center the small icon)
