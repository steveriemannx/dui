...
#if (defined (DUI_BUILD_FOR_LINUX) || defined (DUI_BUILD_FOR_FREEBSD)) && defined (DUI_BUILD_FOR_CEF)
//Linux/FreeBSD OS
...
#endif // (defined (DUI_BUILD_FOR_LINUX) || defined (DUI_BUILD_FOR_FREEBSD)) && defined (DUI_BUILD_FOR_CEF)
