...
void WindowDropTarget::OnDropText(const U8String& utf8Text)
{
    if (!utf8Text.empty()) {
...
void WindowDropTarget::OnDropFile(const U8String& utf8Source, const U8String& utf8File)
{
...
void WindowDropTarget::OnDropComplete()
{
    ...
    if (!m_fileList.empty()) {
        bSendDropMsg = true;
        bool bHandled = false;
        U8String fileSource = m_fileSource;
        std::vector<U8String> fileList = m_fileList;        
        ...
        bSendDropMsg = true;
        bool bHandled = false;
        std::vector<U8String> textList = m_textList;
