...
bool MessageLoop_SDL::CheckInitSDL(const U8String& videoDriverName)
{
    ...
    if (!SDL_WasInit(SDL_INIT_VIDEO)) {
        if (!videoDriverName.empty()) {
            U8String videoDriverNameA = StringConvert::TToUTF8(videoDriverName);
...
U8String MessageLoop_SDL::GetCurrentVideoDriverName()
{
    CheckInitSDL();
    U8String videoDriverName;
