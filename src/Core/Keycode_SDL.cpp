...
{
    //Reference: https://wiki.libsdl.org/SDL2/SDL_ScancodeAndKeycode
    ...
    //Keep consistent with Windows (the Shift, Control and Alt keys are not distinguished between left and right)
