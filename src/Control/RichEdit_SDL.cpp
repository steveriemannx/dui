...
RichEdit::~RichEdit()
{
    ...
    U8String internalFontId = GetInternalFontId();
    if (GlobalManager::Instance().Font().HasFontId(internalFontId)) {
        GlobalManager::Instance().Font().RemoveFontId(internalFontId);
    }
}

U8String RichEdit::GetType() const { return DUI_CTR_RICHEDIT; }

void RichEdit::SetAttribute(const U8String& strName, const U8String& strValue)
{
    if ((strName == ("single_line")) || (strName == ("singleline"))) {
        ...
        if (strValue.find(("left")) != U8String::npos) {
            SetTextHAlignType(HorAlignType::kAlignLeft);
        }
        else if (strValue.find(("hcenter")) != U8String::npos) {
            SetTextHAlignType(HorAlignType::kAlignCenter);
        }
        else if (strValue.find(("right")) != U8String::npos) {
            SetTextHAlignType(HorAlignType::kAlignRight);
        }

        //Vertical alignment
        if (strValue.find(("top")) != U8String::npos) {
            SetTextVAlignType(VerAlignType::kAlignTop);
        }
        else if (strValue.find(("vcenter")) != U8String::npos) {
            SetTextVAlignType(VerAlignType::kAlignCenter);
        }
        else if (strValue.find(("bottom")) != U8String::npos) {
        ...
        if (strValue.find(L',') != U8String::npos) {
            UiSize zoomValue;
        ...
        else if (strValue.find(L'%') != U8String::npos) {
            U8String zoomValue = strValue.substr(0, strValue.find(L'%'));
...
void RichEdit::OnInit()
{
    ...
    U8String fontId = GetCurrentFontId();
    if (fontId.empty()) {
...
bool RichEdit::RemoveInvalidPasswordChar(U8String& text)
{
    bool bRet = false;
    if (!text.empty()) {
        U8String oldText = text;
...
bool RichEdit::RemoveInvalidPasswordChar(std::wstring& text)
{
    bool bRet = false;
    if (!text.empty()) {
...
void RichEdit::ReplacePasswordChar(std::wstring& text) const
{
...
std::wstring::value_type RichEdit::GetPasswordChar() const
{
...
void RichEdit::SetNumberFormat64(const U8String& numberFormat)
{
    U8String format = numberFormat;
#if defined (DUI_BUILD_FOR_WIN)
    StringUtil::ReplaceAll(("lld"), ("I64d"), format);
#else
    StringUtil::ReplaceAll(("I64d"), ("lld"), format);
#endif
    m_numberFormat = format;
}

U8String RichEdit::GetNumberFormat64() const
{
...
void RichEdit::SetFontId(const U8String& strFontId)
{
...
U8String RichEdit::GetFontId() const
{
    return m_sFontId.c_str();
}

U8String RichEdit::GetInternalFontId() const
{
    return StringUtil::Printf(("RichEdit_SDL(0x%p)"), this);
}

U8String RichEdit::GetCurrentFontId() const
{
    U8String fontId = GetInternalFontId();
...
void RichEdit::SetFontIdInternal(const U8String& fontId)
{
    //Create the caret
    ...
    UiRect fontRect = pRender->MeasureString(("T"), measureParam);
...
IFont* RichEdit::GetIFontInternal(const U8String& fontId) const
{
    ASSERT(!fontId.empty());
...
void RichEdit::OnFontChanged(const U8String& fontId)
{
...
void RichEdit::SetTextColor(const U8String& dwTextColor)
{
...
U8String RichEdit::GetTextColor() const
{
...
void RichEdit::SetDisabledTextColor(const U8String& dwTextColor)
{
...
U8String RichEdit::GetDisabledTextColor() const
{
...
void RichEdit::SetSelectionBkColor(const U8String& selectionBkColor)
{
...
U8String RichEdit::GetSelectionBkColor() const
{
    return m_sSelectionBkColor.c_str();
}

void RichEdit::SetInactiveSelectionBkColor(const U8String& selectionBkColor)
{
...
U8String RichEdit::GetInactiveSelectionBkColor() const
{
    return m_sInactiveSelectionBkColor.c_str();
}

void RichEdit::SetCurrentRowBkColor(const U8String& currentRowBkColor)
{
    m_sCurrentRowBkColor = currentRowBkColor;
}

U8String RichEdit::GetCurrentRowBkColor() const
{
    return m_sCurrentRowBkColor.c_str();
}

void RichEdit::SetInactiveCurrentRowBkColor(const U8String& currentRowBkColor)
{
    m_sInactiveCurrentRowBkColor = currentRowBkColor;
}

U8String RichEdit::GetInactiveCurrentRowBkColor() const
{
...
void RichEdit::SetLimitText(int32_t iChars)
{
    ...
    if (m_nLimitText > 0) {
        ...
        if (nTextLen > m_nLimitText) {
            ...
            std::wstring text = m_pTextData->GetText();
...
U8String RichEdit::GetLimitChars() const
{
...
void RichEdit::SetLimitChars(const U8String& limitChars)
{
    m_pLimitChars.reset();
...
int32_t RichEdit::InsertText(int32_t nInsertAfterChar, const U8String& text, bool bCanUndo)
{
...
int32_t RichEdit::AppendText(const U8String& text, bool bCanUndo, bool bScrollBottom)
{
...
U8String RichEdit::GetText() const
{
...
U8String RichEdit::GetTextA() const
{
    return StringConvert::WStringToUTF8(m_pTextData->GetText());
}

std::wstring RichEdit::GetTextW() const
{
    return m_pTextData->GetText();
}
...
void RichEdit::SetText(const std::wstring& strText)
{
    ...
    if (IsPasswordMode()) {
        //Password mode
        std::wstring passwordText = strText;
...
void RichEdit::SetText(const U8String& strText)
{
    //Current memory usage: for 2MB of UTF16 text, the Debug version uses about 23MB of memory, and the Release version uses about 12MB of memory.
    bool bChanged = false;
    std::wstring text = StringConvert::UTF8ToWString(strText);
    if (IsPasswordMode()) {
        //Password mode
        std::wstring passwordText = text;
        RemoveInvalidPasswordChar(passwordText);
        bChanged = m_pTextData->SetText(passwordText);
    }
    else {
...
void RichEdit::SetTextNoEvent(const U8String& strText)
{
...
void RichEdit::SetTextId(const U8String& strTextId)
{
    U8String strText = GlobalManager::Instance().Lang().GetStringViaID(strTextId);
    SetText(strText);
}
...
U8String RichEdit::GetSelectionTextColor() const
{
    ASSERT(0);
    return U8String();
}

void RichEdit::SetSelectionTextColor(const U8String& /*textColor*/)
{
    ASSERT(0);
}

bool RichEdit::ReplaceSel(const U8String& newText, bool bCanUndo)
{
    ...
    bool bRet = false;
    std::wstring text = StringConvert::TToWString(newText);
    if (IsPasswordMode()) {        
...
U8String RichEdit::GetSelText() const
{
    int32_t nStartChar = -1;
    int32_t nEndChar = -1;
    GetSel(nStartChar, nEndChar);
    std::wstring text = m_pTextData->GetTextRange(nStartChar, nEndChar);
#ifdef DUI_UNICODE
    return text;
#else
...
U8String RichEdit::GetTextRange(int32_t nStartChar, int32_t nEndChar) const
{
...
void RichEdit::SetFocusBottomBorderColor(const U8String& bottomBorderColor)
{
    m_sFocusBottomBorderColor = bottomBorderColor;
}

U8String RichEdit::GetFocusBottomBorderColor() const
{
...
U8String RichEdit::GetLine(int32_t nIndex, int32_t nMaxLength) const
{
    if (nMaxLength < 1) {
        return U8String();
    }
    std::wstring rowText = m_pTextData->GetRowText(nIndex);
...
void RichEdit::Paint(IRender* pRender, const UiRect& rcPaint)
{
    ...
    if (!IsPasswordMode()) {
        ...
        std::wstring passwordText = m_pTextData->GetText();
...
void RichEdit::PaintBorder(IRender* pRender)
{
    ...
    U8String borderColor = GetFocusBottomBorderColor();
...
void RichEdit::SetCaretColor(const U8String& dwColor)
{
    m_sCaretColor = dwColor;
}

U8String RichEdit::GetCaretColor() const
{
...
U8String RichEdit::GetPromptText() const
{
    U8String strText = m_sPromptText.c_str();
...
void RichEdit::SetPromptText(const U8String& strText)
{
...
void RichEdit::SetPromptTextId(const U8String& strTextId)
{
...
void RichEdit::SetPromptTextColor(const U8String& promptColor)
{
...
U8String RichEdit::GetPromptTextColor() const
{
...
void RichEdit::PaintPromptText(IRender* pRender)
{
    ...
    U8String promptText = GetPromptText();
    if (promptText.empty()) {
        return;
    }
    U8String promptTextColor = GetPromptTextColor();
...
U8String RichEdit::GetFocusedImage()
{
    if (m_pFocusedImage != nullptr) {
...
void RichEdit::SetFocusedImage( const U8String& strImage )
{
    if (m_pFocusedImage == nullptr) {
...
void RichEdit::ShowPopupMenu(const ui::UiPoint& point)
{
    ...
    U8String skinFolder = ("public/menu/");
    ...
    U8String xml(("rich_edit_menu.xml"));
...
bool RichEdit::SetSpinClass(const U8String& spinClass)
{
    U8String spinBoxClass;
    U8String spinBtnUpClass;
    U8String spinBtnDownClass;
    std::list<U8String> classNames = StringUtil::Split(spinClass, (","));
...
bool RichEdit::SetEnableSpin(bool bEnable, const U8String& spinClass, int32_t nMin, int32_t nMax)
{
    bool bRet = false;
    if (bEnable) {
...
void RichEdit::SetClearBtnClass(const U8String& btnClass)
{
    if (!btnClass.empty()) {
...
void RichEdit::SetShowPasswordBtnClass(const U8String& btnClass)
{
    if (!btnClass.empty()) {
                                  ...
                                  const std::vector<size_t>& modifiedLines) const
{
    ...
    U8String sFontId = GetCurrentFontId();
...
void RichEdit::OnInputChar(const EventArgs& msg)
{
    ...
    if ((msg.vkCode == kVK_RETURN) || (msg.vkCode == kVK_TAB) || (msg.vkCode == kVK_DELETE) || (msg.vkCode == kVK_BACK)) {
        ...
        if ((msg.wParam != 0) && (msg.lParam > 0)) {
            ...
            text = (std::wstring::value_type*)msg.wParam;
        }
    }
