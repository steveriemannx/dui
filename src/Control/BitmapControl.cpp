...
std::string BitmapControl::GetType() const { return DUI_CTR_BITMAP_CONTROL; }

void BitmapControl::SetAttribute(const std::string& strName, const std::string& strValue)
{
    if (strName == "bitmap_halign") {
        ASSERT((strValue == "left") || (strValue == "center") || (strValue == "right"));
        if (strValue == "center") {
    ...
    else if (strName == "bitmap_valign") {
        ASSERT((strValue == "top") || (strValue == "center") || (strValue == "bottom"));
        if (strValue == "center") {
    ...
    else if (strName == "bitmap_margin") {
        UiMargin rcMargin;
        AttributeUtil::ParseMarginValue(strValue.c_str(), rcMargin);
        SetBitmapMargin(rcMargin, true);
    }
    else if (strName == "bitmap_adaptive_dest_rect") {
        SetAdaptiveDestRect(strValue == "true");
    }
    else if (strName == "bitmap_stretch") {
        SetStretchedDrawing(strValue == "true");
    }
    else if (strName == "bitmap_multi_thread") {
        SetSupportMultiThread(strValue == "true");
    }
    else if (strName == "bitmap_file") {
...
void BitmapControl::PaintBitmap(IRender* pRender, const UiRect& rcPaint)
{
    ...
    PerformanceStat statPerformance("BitmapControl::Paint");
