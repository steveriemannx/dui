...
public:
    ...
    */
    ...
    /** Close popup menus when the window is minimized or the user clicks outside them. */
    ...
    virtual LRESULT OnMouseRButtonDownMsg(const ui::UiPoint& pt, uint32_t modifierKey,
                                          const ui::NativeMsg& nativeMsg, bool& bHandled) override;
    virtual LRESULT OnMoveMsg(const ui::UiPoint& ptTopLeft, const ui::NativeMsg& nativeMsg,
