...
void RenderForm::OnInitWindow()
{
    ...
    if (pMenuBar != nullptr) {
        pMenuBar->AddTopMenu(DUI_T("1"), DUI_T("File"),      DUI_T(""), DUI_T("public/menu/rich_edit_menu.xml"));
        pMenuBar->AddTopMenu(DUI_T("2"), DUI_T("Edit"),      DUI_T(""), DUI_T("controls/menu/settings_menu.xml"));
        pMenuBar->AddTopMenu(DUI_T("3"), DUI_T("Selection"), DUI_T(""), DUI_T("public/menu/rich_edit_menu.xml"));
        pMenuBar->AddTopMenu(DUI_T("4"), DUI_T("View"),      DUI_T(""), DUI_T("controls/menu/settings_menu.xml"));
        pMenuBar->AddTopMenu(DUI_T("5"), DUI_T("View"),       DUI_T(""), DUI_T("public/menu/rich_edit_menu.xml"));
        pMenuBar->AddTopMenu(DUI_T("6"), DUI_T("  ...  "),   DUI_T(""), DUI_T("public/menu/rich_edit_menu.xml"), DUI_T(""), DUI_T("text_padding='8,1,8,7'"));
    }
