...
static void BuildUIFromXmlControls(ui::Window* pWindow) {
    ...
    auto* p3 = ui::Create<ui::Label>(pWindow, {{"name", DUI_CTR_CAPTION_TITLE}, {"text", "Controls"}, {"valign", "center"}, {"margin", "8"}, {"mouse_enabled", "false"}});
    ui::Attach(p1, p3);
    ...
    auto* pCloseBtn = ui::Create<ui::Button>(pWindow, {{"class", "btn_wnd_close_11"}, {"height", "stretch"}, {"width", "40"}, {"name", "closebtn"}, {"margin", "0,0,8,2"}, {"tooltip_text", "Close"}});
