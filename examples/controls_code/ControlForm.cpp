...
void ControlForm::GetCreateWindowAttributes(ui::WindowCreateAttributes& attrs)
{
    // Match controls.xml size and macOS system-shadow behavior.
    attrs.m_bInitSizeDefined = true;
    attrs.m_szInitSize.cx = 1100;
