#ifndef EXAMPLES_MOVE_CONTROL_GEN_FORM_H_
#define EXAMPLES_MOVE_CONTROL_GEN_FORM_H_
...
public:
     ...
     */
    virtual DString GetSkinFolder() override { return _T("move_control"); }
...
#endif //EXAMPLES_MOVE_CONTROL_GEN_FORM_H_
