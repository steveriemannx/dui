...
void BuildUIFromXmlRender(ui::Window* pWindow) {
    ...
    auto* pMinBtn = ui::Create<ui::Button>(pWindow, {{"class", "btn_wnd_min_11"}, {"height", "32"}, {"width", "40"}, {"name", "minbtn"}, {"margin", "0,2,0,2"}, {"tooltip_text", "Minimize"}});
    ui::Attach(p6, pMinBtn);

    auto* pMaxBox = ui::Create<ui::Box>(pWindow, {{"height", "stretch"}, {"width", "40"}, {"margin", "0,2,0,2"}});
    ui::Attach(p6, pMaxBox);

    auto* pMaxBtn = ui::Create<ui::Button>(pWindow, {{"class", "btn_wnd_max_11"}, {"height", "32"}, {"width", "stretch"}, {"name", "maxbtn"}, {"tooltip_text", "Maximize"}});
    ui::Attach(pMaxBox, pMaxBtn);

    auto* pRestoreBtn = ui::Create<ui::Button>(pWindow, {{"class", "btn_wnd_restore_11"}, {"height", "32"}, {"width", "stretch"}, {"name", "restorebtn"}, {"visible", "false"}, {"tooltip_text", "Restore"}});
    ui::Attach(pMaxBox, pRestoreBtn);

    auto* pCloseBtn = ui::Create<ui::Button>(pWindow, {{"class", "btn_wnd_close_11"}, {"height", "stretch"}, {"width", "40"}, {"name", "closebtn"}, {"margin", "0,0,0,2"}, {"tooltip_text", "Close"}});
    ...
    ui::WindowBuilder::ParseRichTextXmlText("<RichText><b><a href=\"www.sohu.com\">This is a hyperlink: click to visit Sohu</a></b></RichText>", p1063);
    ...
    ui::WindowBuilder::ParseRichTextXmlText("<RichText><b><a href=\"www.sohu.com\">This is a hyperlink: click to visit Sohu</a></b></RichText>", p1065);
    ...
    ui::WindowBuilder::ParseRichTextXmlText("<RichText><b><a href=\"www.sohu.com\">This is a hyperlink: click to visit Sohu</a></b></RichText>", p1067);
    ...
    ui::WindowBuilder::ParseRichTextXmlText("<RichText><b><a href=\"www.sohu.com\">This is a hyperlink: click to visit Sohu</a></b></RichText>", p1069);
    ...
    ui::WindowBuilder::ParseRichTextXmlText("<RichText><b><a href=\"www.sohu.com\">This is a hyperlink: click to visit Sohu</a></b></RichText>", p1071);
    ...
    ui::WindowBuilder::ParseRichTextXmlText("<RichText><b><a href=\"www.sohu.com\">This is a hyperlink: click to visit Sohu</a></b></RichText>", p1073);
    ...
    ui::WindowBuilder::ParseRichTextXmlText("<RichText><b><a href=\"www.sohu.com\">This is a hyperlink: click to visit Sohu</a></b></RichText>", p1075);
    ...
    ui::WindowBuilder::ParseRichTextXmlText("<RichText><b><a href=\"www.sohu.com\">This is a hyperlink: click to visit Sohu</a></b></RichText>", p1077);
    ...
    ui::WindowBuilder::ParseRichTextXmlText("<RichText><b><a href=\"www.sohu.com\">This is a hyperlink: click to visit Sohu</a></b></RichText>", p1079);
