...
public:
     ...
     */
    virtual DString GetSkinFolder() override { return DUI_T("dpi_aware"); }
...
private:
    ...
    /** Build the UI in pure code (corresponding to the DpiAware.xml layout)
    */
    void BuildUI();
...
#endif //EXAMPLES_DPI_DISPLAY_SCALE_MAIN_FORM_H_
