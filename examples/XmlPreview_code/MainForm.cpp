...
void MainForm::BuildUI()
{
    ...
    auto* pXmlBox = ui::Create<ui::XmlBox>(this, {{"border_color", "splitline_level1"}, {"border_size", "1"}, {"border_dash_style", "dash"}, {"margin", "4"}, {"width", "stretch"}, {"height", "stretch"}, {"mouse_child", "true"}, {"res_path", "controls"}, {"xml_file_path", "controls.xml"}});
