...
#include "generated_ui.inc"  // Build-time generated pure C++ UI code (from controls.xml)
...
{
    // In gen mode the window is not loaded from XML, so the skin folder must be
...
{
    // Build-time generated from controls.xml
    ::InitControls(this);  // Build-time generated function (distinct from Window::InitControls, uses the global scope)
}
...
void ControlForm::ShowTrayMenu(int32_t x, int32_t y)
{
    ...
    {
        struct TrayItem { std::string name; std::string text; };
