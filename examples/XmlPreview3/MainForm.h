...
public:
    ...
    */
    virtual DString GetSkinFolder() override { return DUI_T("xml_preview3"); }
    ...
    */
    virtual DString GetSkinFile() override { return DUI_T("xml_preview3.xml"); }
...
private:
    ...
    /** Fill the source XML into the edit controls
    */
    void FillSourceEdits();

    /** Fill the demo combos inside the previewed XML
    */
    void FillDemoCombos();

    /** Fill the demo list inside the previewed XML
    */
    void FillDemoList();
