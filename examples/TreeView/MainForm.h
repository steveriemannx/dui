...
public:
     ...
     */
    virtual std::string GetSkinFolder() override { return "tree_view"; }
    virtual std::string GetSkinFile() override { return "tree_view.xml"; }
...
private:
    ...
    */
    bool OnShowAddressPath(const std::string& newFilePath);
