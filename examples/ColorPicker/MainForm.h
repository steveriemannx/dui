#ifndef EXAMPLES_COLORPICKER_MAIN_FORM_H_
#define EXAMPLES_COLORPICKER_MAIN_FORM_H_
...
// Do NOT add GetSkinFolder()/GetSkinFile()/BuildUI() here.
...
#endif //EXAMPLES_COLORPICKER_MAIN_FORM_H_
