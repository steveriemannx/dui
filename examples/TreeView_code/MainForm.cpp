#include "MainForm.h"
#include "TreeViewBuildUI.inc"  // Pure code UI construction (corresponds to the tree_view.xml layout)
...
void MainForm::GetCreateWindowAttributes(ui::WindowCreateAttributes& attrs)
{
    ...
    attrs.m_szInitSize.cx = (int32_t)(rcWork.Width() * 0.80f);
    attrs.m_szInitSize.cy = (int32_t)(rcWork.Height() * 0.80f);
...
void MainForm::OnInitWindow()
{
    ...
    // Pure code UI construction (corresponds to the tree_view.xml layout)
    BuildUIFromXml(this);
