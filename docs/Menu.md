...
<Window shadow_type="menu_round" shadow_attached="true" layered_window="true" >
    <MenuListBox class="menu" name="main_menu">
        ...
        <MenuItem class="menu_element" name="first" width="180">
          <Button name="button_01" width="auto" height="auto" bkimage="menu_settings.svg" valign="center" mouse_enabled="false" keyboard_enabled="false"/>
        ...
        <MenuItem class="menu_element" name="second" width="180">
          <Button name="button_02" width="auto" height="auto" bkimage="menu_item.svg" valign="center" mouse_enabled="false" keyboard_enabled="false"/>
        ...
        <HBox class="menu_split_box" height="36">
            ...
            <Control width="auto" height="auto" bkimage="menu_speaker.svg" valign="center" mouse_enabled="false" keyboard_enabled="false"/>
        ...
        <MenuItem class="menu_element" name="third" width="180">
            <Button name="button_03" width="auto" height="auto" bkimage="menu_item.svg" valign="center" mouse_enabled="false" keyboard_enabled="false"/>
        ...
        <MenuItem class="menu_element" name="fourth" width="180">
            ...
            <MenuItem class="menu_element" name="sub_menu0" width="180">
                <Button name="button_44" width="auto" height="auto" bkimage="sub_menu.svg" valign="center" mouse_enabled="false" keyboard_enabled="false"/>
