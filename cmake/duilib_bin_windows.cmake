...
if(DUILIB_WEBVIEW2_EXE)    
    ...
    link_directories("${DUILIB_ROOT}/third_party/Microsoft.Web.WebView2/build/native/${DUILIB_SYSTEM_PROCESSOR}") 
endif()
...
if(DUILIB_WEBVIEW2_EXE)
    ...
    add_custom_command(TARGET ${PROJECT_NAME} POST_BUILD  # executed after the target is built
                       COMMAND ${CMAKE_COMMAND} -E copy
                               "${DUILIB_ROOT}/third_party/Microsoft.Web.WebView2/build/native/${DUILIB_SYSTEM_PROCESSOR}/WebView2Loader.dll"
