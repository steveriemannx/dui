...
# Default: the CEF distribution inside the project (third_party/libcef/cef_binary); override with -DCEF_ROOT=...
#
if(NOT CEF_ROOT)
    get_filename_component(CEF_ROOT "${CMAKE_CURRENT_LIST_DIR}/../third_party/libcef/cef_binary" ABSOLUTE)
endif()
...
set(CEF_PROJECT_HELPER_SRCS
        ${DUI_PROJECT_SRC_DIR}/mac/process_helper_mac.cc
   )

# cef project resources.
set(CEF_PROJECT_RESOURCES_SRCS
        ${DUI_PROJECT_SRC_DIR}/mac/Info.plist.in
        ${DUI_PROJECT_SRC_DIR}/mac/default_icon.icns
   )
...
set(CEF_TARGET_OUT_DIR "${DUI_BIN_PATH}")
...
#        -Werror                         # Treat warnings as errors
    ...
    foreach(_suffix_list ${CEF_HELPER_APP_SUFFIXES})
        ...
        # Build-order wiring: helpers also link the Skia archive built at make time
        if(TARGET dui_skia)
    ...
    # Copy dui resources into the Resources directory.
    if("${DUI_THEME_DIR_NAME}" STREQUAL "")
...
# Avoid linking before the wrapper archive is done in parallel builds (linking by -l name has no build-order dependency)
